...
- [Cisco Warns of High-Severity ClamAV Vulnerabilities With Public PoC](https://www.securityweek.com/cisco-warns-of-high-severity-clamav-vulnerabilities-with-public-poc/)
  ...
  - _<p>Remote, unauthenticated attackers could exploit the bugs to cause a denial-of-service (DoS) condition.</p> <p>The post <a href="https://www.securityweek.com/cisco-warns-of-high-severity-clamav-vuln_

- [Metabase zero-day exploited to access Framework customer data](https://www.helpnetsecurity.com/2026/08/10/metabase-zero-day-framework-tally-kilo-code/)
  - Confidence: 🟢 HIGH
  - Tags: `free_cert`, `free_training`
...
- [Critical Flaws Discovered in Belgian eID Software Used by 2 Million People](https://www.securityweek.com/critical-flaws-discovered-in-belgian-eid-software-used-by-2-million-people/)
  - Confidence: 🟫 LOW
  - _<p>The vulnerabilities affected software used by eight of Belgium’s ten largest banks and over 60 government agencies.</p> <p>The post <a href="https://www.securityweek.com/critical-flaws-discovered-i_
...
- [Corporate Data Stolen in Levi Strauss Cyberattack](https://www.securityweek.com/corporate-data-stolen-in-levi-strauss-cyberattack/)
  - Confidence: 🟫 LOW
  - _<p>Using social engineering, a threat actor accessed the computers of three employees and exfiltrated data from them.</p> <p>The post <a href="https://www.securityweek.com/corporate-data-stolen-in-lev_
...
- [CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability](https://www.securityweek.com/cisa-urges-immediate-patching-of-exploited-progress-loadmaster-vulnerability/)
  - Confidence: 🟫 LOW
  - _<p>The critical-severity flaw allows unauthenticated, remote attackers to execute arbitrary commands.</p> <p>The post <a href="https://www.securityweek.com/cisa-urges-immediate-patching-of-exploited-p_
...
- [Novel Private APN Pivot Let Hackers Sabotage Second Polish Energy Facility](https://www.securityweek.com/novel-private-apn-pivot-let-hackers-sabotage-second-polish-energy-facility/)
  - Confidence: 🟫 LOW
  - _<p>CERT.PL said this appears to be the first instance of a private APN being used as an attack vector.</p> <p>The post <a href="https://www.securityweek.com/novel-private-apn-pivot-let-hackers-sabotag_
...
- [Metabase Patches Vulnerability Exploited as Zero-Day](https://www.securityweek.com/metabase-patches-vulnerability-exploited-as-zero-day/)
  - Confidence: 🟫 LOW
  - _<p>The security defect allows unauthenticated, remote attackers to gain administrative access to Metabase instances.</p> <p>The post <a href="https://www.securityweek.com/metabase-patches-vulnerabilit_
...
- [New Jersey, Alabama Join States Targeted in Water Cyberattacks](https://www.securityweek.com/new-jersey-alabama-join-states-targeted-in-water-cyberattacks/)
  - Confidence: 🟫 LOW
  - _<p>Hackers linked to Iran targeted industrial control systems (ICS) at water facilities in at least a dozen US states.</p> <p>The post <a href="https://www.securityweek.com/new-jersey-alabama-join-sta_
...
- [‘Ghostjacking’ Attack Uses Poisoned Logs to Turn AI Agents Bad](https://www.securityweek.com/ghostjacking-attack-uses-poisoned-logs-to-turn-ai-agents-bad/)
  - Confidence: 🟫 LOW
  - _<p>An AI agent executes instructions that an attacker has planted in the log or alert that records a blocked request word for word.</p> <p>The post <a href="https://www.securityweek.com/ghostjacking-a_
...
- [Stealthium Targets Security Blind Spots in AI Accelerators and Neo-Clouds](https://www.securityweek.com/stealthium-targets-security-blind-spots-in-ai-accelerators-and-neo-clouds/)
  - Confidence: 🟫 LOW
  - _<p>The startup analyzes subtle telemetry signals to detect attacks that traditional security tools cannot see inside accelerator-powered AI infrastructure.</p> <p>The post <a href="https://www.securit_
...
- [OpenAI’s Upcoming Astra Model Raises Autonomous Cyberattack Concerns](https://www.securityweek.com/openais-upcoming-astra-model-raises-autonomous-cyberattack-concerns/)
  - Confidence: 🟫 LOW
  - _<p>The current GPT-5.6-Sol has been assigned a ‘high’ cybersecurity threshold, but Astra could reach the maximum ‘critical’ threshold. </p> <p>The post <a href="https://www.securityweek.com/openais-up_
...
- [Python Now Has a Post-Quantum Encryption Library](https://www.schneier.com/blog/archives/2026/08/python-now-has-a-post-quantum-encryption-library.html)
  - Confidence: 🟫 LOW
  - _<p><a href="https://blog.trailofbits.com/2026/06/30/shipping-post-quantum-cryptography-to-python/">This is good</a>:</p> <blockquote><p>Post-quantum cryptography is now one pip-install away for the en_

- [71% of CISOs spend 10+ hours on board reports](https://www.helpnetsecurity.com/2026/08/10/ciso-board-communication-gap-report/)
  - Confidence: 🟫 LOW
  - _<p>Boards want evidence that security controls and architecture reduce business risk, expressed in terms of resilience, consequence, and decision relevance. Translating technical findings into busines_

- [Product showcase: Enpass Password Manager breaks away from the proprietary cloud model](https://www.helpnetsecurity.com/2026/08/10/product-showcase-enpass-password-manager/)
  - Confidence: 🟫 LOW
  - _<p>Enpass is a password manager that stores passwords, passkeys, payment cards, identities, secure notes, software licenses, and other sensitive information in encrypted vaults. Vaults remain on the d_

- [Chainloop: Open-source evidence store and policy engine for the software supply chain](https://www.helpnetsecurity.com/2026/08/10/chainloop-open-source-supply-chain-security/)
  - Confidence: 🟫 LOW
  - _<p>Chainloop is an open source evidence store for the software supply chain. A command line tool runs inside a GitHub Actions, GitLab, Jenkins, or Dagger pipeline, picks up what the build produced, up_

- [GitHub Dependabot malware alerts now cover eight ecosystems](https://www.helpnetsecurity.com/2026/08/10/github-dependabot-malware-alerts/)
  - Confidence: 🟫 LOW
  - _<p>GitHub has flagged npm malware since March 2026. Anyone pulling in a bad PyPI, Maven, RubyGems, NuGet, Go, crates.io, or PHP Composer package has had no such warning, because GitHub&#8217;s malware_

- [OpenAI locks down Astra over potential critical cyber capabilities](https://www.helpnetsecurity.com/2026/08/10/openai-astra-critical-cyber-capabilities/)
  - Confidence: 🟫 LOW
  - _<p>OpenAI&#8217;s internal evaluation of its upcoming model, Astra, found significant advances in agentic coding and cybersecurity, leading the company to conclude that it cannot rule out the model re_

- [Anthropic to put AI in charge of reviewing Claude Code actions by default](https://www.helpnetsecurity.com/2026/08/10/anthropic-claude-code-auto-mode/)
  - Confidence: 🟫 LOW
  - _<p>Anthropic will make auto mode in Claude Code the default for new sessions on Pro, Max, and Team plans starting August 14. Users who previously selected a different default may receive a one-time pr_

- [N-able ships second N-central hotfix as attackers keep exploiting CVE-2026-18577](https://www.helpnetsecurity.com/2026/08/10/cve-2026-18577-n-central-hotfix-2-msps/)
  - Confidence: 🟫 LOW
  - _<p>To help customers fend off ongoing attacks, N-able released a second security hotfix for N‑central, its monitoring and management (RMM) solution popular with managed service providers (MSPs). &#822_

- [Microsoft Entra ID is removing an extra MFA hurdle for Windows Hello and macOS PSSO users](https://www.helpnetsecurity.com/2026/08/10/entra-id-windows-hello-macos-psso-standalone-mfa/)
  - Confidence: 🟫 LOW
  - _<p>Microsoft is changing how Entra ID handles MFA for people who sign in with Windows Hello for Business (WHfB) or macOS Platform Single Sign-On (PSSO). The rollout reaches worldwide and GCC tenants s_
...
- [Cyberattack on Steam hardware shipper leaks names, addresses, and order data](https://www.helpnetsecurity.com/2026/08/10/valve-data-breach-ceva-logistics-steam-hardware/)
  - Confidence: 🟫 LOW
  - _<p>Video game publisher Valve is alerting customers in Europe to a data breach at CEVA Logistics, its Steam hardware shipping partner. Reports from affected customers began surfacing on social media e_
...
- [Outdated Cybercrime Laws Put Security Researchers at Risk](https://www.darkreading.com/application-security/outdated-cybercrime-laws-security-researchers-risk)
  - Confidence: 🟫 LOW
  - _A public policy expert mapped global cybercrime laws to develop a five-point framework for protecting ethical hackers and good-faith security research._
...
- [Coruna, DarkSword iOS Exploits Proliferate Globally](https://www.darkreading.com/vulnerabilities-threats/coruna-darksword-ios-exploits-proliferate-globally)
  - Confidence: 🟫 LOW
  - _Sophisticated iPhone exploit chains previously limited to nation-states are spreading far and wide to organized cybercrime groups._
