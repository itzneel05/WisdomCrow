---
title: WisdomCrow Weekly Report - 2026-07-19
date: 2026-07-19T19:37:40Z
type: radar-report
report_type: weekly
...
- [Two new high severity WordPress vulnerabilities, patch immediately!](https://www.helpnetsecurity.com/2026/07/18/wordpress-vulnerabilities-wp2shell-cve-2026-60137-cve-2026-60137/)
  - Confidence: 🟡 MEDIUM
  - Tags: `bug_bounty`
  - _<p>The 7.0.2 WordPress security release addresses one critical and one high severity security issue. The vulnerabilities reported to the WordPress security team include: CVE-2026-60137 &#8211; A facil_
...
- [Metasploit Wrap Up: An HTTP to SMB relay plus Payload Improvements](https://www.rapid7.com/blog/post/pt-metasploit-wrap-up-an-http-to-smb-relay-plus-payload-improvements)
  - Confidence: 🟢 HIGH
  - Tags: `open_source`
  - _<h2>Metasploit Wrap Up Housekeeping</h2><p>While the Metasploit Framework will be continuing its weekly release cadence, bringing you dear reader our latest content, the Weekly Wrap Up is being shifte_
...
- [Inc Ransomware Exploits SonicWall SMA Zero-Days](https://www.darkreading.com/vulnerabilities-threats/inc-ransomware-exploits-sonicwall-sma-zero-days)
  - Confidence: 🟫 LOW
  - _When chained together, the two vulnerabilities allow threat actors to gain root-level capabilities on SonicWall's mobile access appliances._
